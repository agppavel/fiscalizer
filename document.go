...
func NewDocument(domain int, cash, non_cash, total float32, png_bill bool) document {
	return Document{IdDomain: domain, Cash: cash, NonCash, non_cash, Total: Total, PngBill: png_bill}
}
